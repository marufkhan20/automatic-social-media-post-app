  ...
  return (
    <AdminLayout>
      <div className="flex flex-col gap-y-10 items-start justify-start text-black w-full">
        <div className="flex flex-col justify-start items-start gap-5 w-full h-screen bg-[#EFF6F9]  px-5  pt-6 pb-10">
          <div className="flex justify-center flex-col items-center mx-auto py-32 md:py-20">
            <div className="flex flex-col md:flex-row gap-3 md:gap-0 md:space-x-4">
              {tabs.map((tab, index) => (
                <button
                  ...
                  className={`${
                    activeTab === index
                      ? "bg-[#012B6D] text-white border border-transparent"
                      : "bg-white border-[#ADADAD] border"
            ...
            <div className="mt-4 w-[100%] md:w-[75%] mx-auto">
