        ...
        <DashboardLayout>
          ...
          >
            ...
            <div className="flex items-center gap-5">
              <button
                onClick={showModal}
                className="px-6 flex  flex-row items-center gap-3 h-[35px] group rounded-md text-white font-[400] md:font-[500] hover:bg-transparent border border-transparent hover:border-[#012B6D] transition-all duration-300 ease-in hover:text-[#012B6D] bg-[#012B6D]"
              >
                <AiOutlinePlus
                  size={20}
              ...
              <button className="border hover:text-white ease-in flex items-center gap-1 justify-center  text-[#ADADAD] group duration-300 transition-all hover:bg-[#ADADAD] rounded-md border-[#ADADAD] w-[130px] h-[33px]">
                <MdManageHistory
                  className="text-[#ADADAD] group-hover:text-white"
                  size={20}
                />
                Manage
              </button>
            </div>
            <p className="text-xs px-10">You dont have any campaigns.</p>
          </div>
          <div
          ...
          <div
            className="flex flex-col mt-5 justify-start items-start gap-3 w-full bg-white rounded-md  px-5 md:px-10 py-6"
            style={{ boxShadow: "0px 4px 4px 0px rgba(0, 0, 0, 0.25)" }}
          >
