      ...
      <DashboardLayout>
        <div className="flex flex-col gap-y-10 justify-center md:justify-start items-center md:items-start w-full">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <p className="text-[25px] font-[500]">Overview</p>
            </div>
            <div className="flex flex-col items-center justify-center w-full">
              <div
                onClick={showModal}
                className="w-[296px] cursor-pointer h-[153px] flex items-center justify-center border border-[#ADADAD]"
              >
                <img
                  src="/images/meet.jpg"
                  alt=""
          ...
          >
            <div className="flex  items-center gap-3">
              ...
              <p className="text-[25px] font-[500]">Scheduled Post</p>
            </div>
            <div className="flex items-center gap-3 mt-3 ">
              <button
                onClick={showModal2}
                className="px-6 h-[35px] hover:border-[#012B6D] border border-transparent transition-all ease-in duration-300 hover:text-[#012B6D] hover:bg-[white] bg-[#012B6D] rounded-md text-[white] font-[500] "
              >
                New Post
              </button>
              <button
                onClick={showModal3}
                className="border rounded-md px-[5px] md:px-4 h-[35px] border-[#4A4A4A] text-[#4A4A4A]"
              >
                Use a Template
              </button>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <p className="text-[25px] font-[500]">Text Replacements</p>
            </div>
        ...
        >
          ...
          <div className="flex flex-col mt-3 gap-3">
            <p className="text-[18px]">Template folders:</p>
            <div>
              <select
                id="postSelector"
                name="postSelector"
            ...
            <p className="text-[18px]">Select a template to import:</p>
            <div>
              <select
                id="postSelector"
                name="postSelector"
