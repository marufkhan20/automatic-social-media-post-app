...
const ImageGallery = () => {
  ...
  const { data: galleries, isLoading: loading } = useGetGalleriesQuery("video");
    ...
    <div>
      <DashboardLayout>
        <div className="flex flex-col gap-y-10 items-start justify-start w-full">
          ...
          >
            <div className="flex justify-between items-center w-full">
              ...
              <div className="border flex items-center rounded-md text-[#4A4A4A] border-[#4A4A4A] ">
                ...
                <button
                  onClick={showModal2}
                  className="flex items-center py-3 gap-1 px-3 hover:shadow-lg transition-all ease-in duration-300"
                >
                  <GoShare size={20} />
                  <p>Import</p>
                </button>
              ...
              {!loading &&
                ...
                galleries?.map((gallery) => (
                  ...
                  >
                    ...
                    <div className="py-5 px-5 flex flex-col gap-1 bg-gray-500">
                      <p className="text-[18px] font-[700] text-white">
                        {gallery?.folderName}
                      </p>
                      <p className="text-[16px] font-[400] text-[white]">
                        {gallery?.resources?.length} Videos
                      </p>
                    </div>
                  </div>
                ))}
          ...
          >
            ...
            <div className="">
              ...
              <p
                onClick={showModal4}
                className="flex mt-5 justify-center items-center rounded-md border w-[150px] h-[150px] overflow-hidden "
              >
                <iframe
                  width="120"
                  height="120"
                  src="https://www.youtube.com/embed/IXFX8Snp_GU?si=shU8QPK7sXRdAul6&amp;start=20"
              ...
              <div>{/* put Videos here that uploaded  */}</div>
            </div>
          </div>
        </div>
        <Modal
        ...
        >
          ...
          <div className="my-10 text-[#4A4A4A] flex flex-col justify-center items-center w-full">
            ...
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/IXFX8Snp_GU?si=E_cCSRvOmA_DWNED&amp;start=20"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowfullscreen
        ...
        >
          ...
          <div className="my-10">
            <Upload2 galleries={galleries} handleCancel={handleOk} />
          </div>
        </Modal>
        <Modal
          title={null}
        ...
        >
          ...
          <div>
            <form className="flex my-8 flex-col justify-start items-start gap-5 ">
