        ...
        >
          ...
          <div className="overflow-x-scroll md:overflow-hidden overflow-y-hidden w-full">
            <table className="w-full ">
              ...
              {!pendingUsers && (
                <p className="text-center">Manager Not found!!</p>
              )}
              ...
              <tbody className="cursor-pointer">
                {pendingUsers?.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="p-2">{item?.manager?.email}</td>
                    ...
                    <td>
                      <div className="flex items-center gap-3">
                        <button
                          class={`w-[120px] h-[35px] rounded-md text-white font-[500] border border-transparent ${
                            item?.status === "pending" &&
                            "hover:border-[#012B6D] hover:bg-transparent hover:text-[#012B6D]"
        ...
        >
          ...
          <div className="overflow-x-scroll md:overflow-hidden overflow-y-hidden w-full">
            <table className="w-full ">
              ...
              {!activeUsers && (
                <p className="text-center">Manger Not found!!</p>
              )}
