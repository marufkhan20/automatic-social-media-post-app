        ...
        <div className="flex flex-col gap-y-10 items-start justify-start w-full">
          ...
          >
            ...
            <div className="flex flex-col gap-4 md:py-5 md:px-5">
              <p className="text-[18px] font-[600]">Your Billing Details</p>
              <div className="px-5">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-10 mt-10">
              {packages?.map((item) => (
                <div
                  className="flex bg-white border-[#ADADAD] border rounded-lg flex-col text-center  justify-center items-center px-7 pt-7 pb-16"
                  key={item?._id}
                >
                  <div className="flex flex-col justify-center items-center gap-3 text-[black]">
                    <h1 className="text-[35px] font-[900]">{item?.name}</h1>
                    <div className="flex items-center">
                      <span className="text-[36px] font-[800]">
                        ${item?.price}
                      </span>
                      <p className="text-[#4A4A4A] font-[400] text-[25px]">
                        /month
                      </p>
                    </div>
                    <button
                    ...
                    <div className="flex flex-col justify-center gap-2 items-center">
                      {item?.offers?.map((offer) => (
                        <p
                          key={offer?.id}
                          className="text-[18px] font-[500] flex items-center gap-2"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="8"
          ...
          <div>
            <div className="flex flex-col gap-4 pt-6">
              <p className="text-[16px] font-[500]">
                Thankyou for a choosing to purchase a subscription to Social
                Reach Pro!
              </p>
              <p className="text-[16px]">
                You will be charged today to begin your subscription, and your
                card will be charged automatically when your pre-paid month (or
                year) ends.
              </p>
              <p className="text-[16px]">
                Vizzlie does not offer refunds, however you can cancel your
                subscription at any time and enjoy your paid benefits until what
                would have been your renewal date.
              </p>
            </div>
            <div className="flex flex-col justify-center items-center text-center pt-6">
              <p>
                Subscription Level: <span className="font-[500]">Core</span>
              </p>
              <button
                onClick={() => {
                  showModal3();
                ...
                className="bg-[#012B6D] my-3 hover:bg-blue-900 text-white  py-2 px-6 rounded-md focus:outline-none focus:shadow-outline"
              >
